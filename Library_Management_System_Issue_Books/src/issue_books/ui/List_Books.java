...
public static void main(String[] args) {
	   ...
	   private void initialize() {
	       ...
	       frame = new JFrame("View Book List");
	       ...
	       frame.getContentPane().setLayout(null);
			...
			String[] col = { "BookID", "UserID", "Issued Date", "Period" };
		...
		public String[][] getListBooksToStringArray() {
			...
			List<issueBook> books = service.listIssueBooks();
			String[][] booksStringArray = new String[books.size()][];

			for (int i = 0; i < books.size(); i++) {
				issueBook book = books.get(i);
				booksStringArray[i] = new String[] { String.valueOf(book.getBookId()),String.valueOf(book.getUserId()), book.getIssueDate(), String.valueOf(book.getPeriod())};
			}
